...
public interface IMatrixCheckEmpty<T>
{
    ...
    /// <summary>
    /// Проверяет, что элемент является пустым
    /// </summary>
...
internal class FigureMatrixCheckEmpty : IMatrixCheckEmpty<Figure>
{
    ...
    /// <summary>
    /// Проверка, что переданный элемент равен null
    /// </summary>
...
/// </summary>
/// <typeparam name="T">Тип элемента матрицы</typeparam>
/// <param name="maxX">Количество столбцов</param>
/// <param name="maxY">Количество строк</param>
/// <param name="checkEmpty">Объект проверки пустых элементов</param>
public class Matrix<T>(int maxX, int maxY, IMatrixCheckEmpty<T> checkEmpty)
{
    /// <summary>
    /// Словарь для хранения значений матрицы
    /// </summary>
    ...
    /// <summary>
    /// Ширина столбца при выводе матрицы
    /// </summary>
